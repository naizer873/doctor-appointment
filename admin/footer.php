            ...
            <footer class="sticky-footer bg-dark">
                <div class="container my-auto">
                    <div class="copyright text-bold text-white text-center my-auto">
                        <span>Copyright &copy; Jacob <?php echo date('Y'); ?></span><br>
                        <p class="my-auto"> Doctor Appointment Management System</p>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
