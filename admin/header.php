...
<head>
    ...
    <title>Doctor Appointment Management System</title>
    	<!-- Favicon icon -->
	<link rel="icon" type="image/png" size="20x20" href="../image/img11.jpg">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <i class="fas fa-lg fa-laugh-wink"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="doctor.php">
                    <i class="fas fa-lg fa-user-md"></i>
                    <span>Doctor</span></a>
            </li>
            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        if($_SESSION['type'] == 'Admin')
                        {
                            ...
                            foreach($user_result as $row)
                            {
                                ...
                                $user_profile_image = '../image/img10.jpg';
                            }
                        }
